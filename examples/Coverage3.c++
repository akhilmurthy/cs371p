...
/*
% g++-7 -fprofile-arcs -ftest-coverage -pedantic -std=c++14 -Wall -Weffc++ -Wextra Coverage3.c++ -o Coverage3 -lgtest -lgtest_main -pthread
...
% gcov-7 -b Coverage3.c++ | grep -A 5 "File '.*Coverage3.c++'"
File 'Coverage3.c++'
