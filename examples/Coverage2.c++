...
/*
% g++-7 -fprofile-arcs -ftest-coverage -pedantic -std=c++14 -Wall -Weffc++ -Wextra Coverage2.c++ -o Coverage2 -lgtest -lgtest_main -pthread
...
% gcov-7 -b Coverage2.c++ | grep -A 5 "File '.*Coverage2.c++'"
File 'Coverage2.c++'
